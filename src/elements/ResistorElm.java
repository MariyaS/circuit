...
class ResistorElm extends CircuitElm {
	...
	String dump() {	return super.dump() + " " + resistance;	}
	...
	void calculateCurrent() { current = (volts[0]-volts[1])/resistance; }
	
	void stamp() { sim.stampResistor(nodes[0], nodes[1], resistance); }
